import { LayoutDashboard, Users, Network, Activity, BarChart3, Settings, Lock, MessageCircle } from 'lucide-react';
...
function Navbar() {
    ...
    const navItems: NavItem[] = [
        ...
        { path: '/chat', label: t('nav.chat') || 'Chat', icon: MessageCircle, priority: 'medium' },
